        ...
        <>
            <div className='sep1' id='sep1'>
                ...
                <div className='animated-page-1' id='animated-page-1' ref={page}>
                    <div className='hmmm'>
                        <div className='box' id='box1' ref={animatedElement}>
                        </div>
                        <button className='see-more-btn' id='more1' onClick={more1}>More Info...</button>
                        <img className='overlay-img' src={char} ref={img1} />
                        <p className='game-text'>NIER <br></br><span className='val'>AUTOMATA</span></p>
                    </div>
                </div>
            </div>
                ...
                <div className='sep2'>
                    ...
                    <div className='animated-page-2' id='animated-page-2' ref={page2}>
                        <div className='hmmm'>
                            <div className='box' id='box2' ref={animatedElement2}>
                            </div>
                            <button className='see-more-btn'>More Info...</button>
                            <img className='overlay-img-2' src={char2} ref={img2} />
                            <p className='game-text'>ELDEN <br></br><span className='val'>RING</span></p>
                        </div>
                ...
                <div className='sep3'>
                    ...
                    <div className='animated-page-3' id='animated-page-3' ref={page3}>
                        <div className='hmmm'>
                            <div className='box' id='box3' ref={animatedElement3}>
                            </div>
                            <button className='see-more-btn'>More Info...</button>
                            <img className='overlay-img-3' src={char3} ref={img3} />
                            <p className='game-text'>MORTAL <br></br><span className='val'>KOMBAT</span></p>
                        </div>
